...
db.insert(agents).values([
  ...
  { id: sentinelId, agentId: 'sentinel', name: 'Sentinel', role: 'QA Engineer', persona: 'Quality guardian', teamId: ctoTeamId, status: 'idle', specialization: 'QA', model: 'kimi-k2.5', capabilities: '["testing","automation","quality-assurance"]', parentAgentId: ctoId, createdAt: now, updatedAt: now },
